...
**Before running the demo on your computer please include the requisite circomlib location at the top of `AuthenticatedDT.circom` file in the `adt` folder.** A simple example can be run by running command `bash demo.sh` in the `adt` folder.
